...
$branch = mysqli_real_escape_string($conn,$_POST['branch']);
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   $sql = $conn->query("UPDATE  student  SET  sname  = '$sname', contact  = '$contact', branch  = '$branch', joindate = '$joindate', about ='$about', emailid= '$emailid'  WHERE  id  = '$id'");
...
yearRange: "1970:<?php echo date('Y');?>"
    ...
    <div id="footer-sec">
	School Fees Payment System | Brought To You By : Yogesh Kumar Gupta
    </div>
